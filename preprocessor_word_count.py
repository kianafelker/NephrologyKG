...
#to run
#pipenv run python preprocessor_word_count.py

#for getting list of words, word count dictionary, most frequent words
    ...
    with open(output_file, 'a') as outfile:
        ...
        for names in file_names:
            with open(names) as infile:
                final_list += preprocess(names)
        outfile.write(repr(final_list))
...
def highest_dict_value(file_names, output_file):
    with open(output_file, 'a') as outfile:
        final_list = []
        for names in file_names:
            with open(names) as infile:
